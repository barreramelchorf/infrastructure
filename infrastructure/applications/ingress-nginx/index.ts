      ...
      controller: {
        ...
        service: {
          ...
          annotations: {
            ...
            'service.beta.kubernetes.io/aws-load-balancer-subnets': config.project.require('internalSubnetIds'),
      ...
      controller: {
        ...
        service: {
          ...
          annotations: {
            ...
            'service.beta.kubernetes.io/aws-load-balancer-cross-zone-load-balancing-enabled': 'true',
            'service.beta.kubernetes.io/aws-load-balancer-type': 'nlb',
            'service.beta.kubernetes.io/aws-load-balancer-subnets': config.project.require('externalSubnetIds'),
